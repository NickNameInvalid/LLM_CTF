...
PROMPT_INIT = """\
Below is a question in CTF in {category} category, which is {category_description}, called {name}. Help me solve it. Either directly derive the flag from the code, or write a python 
